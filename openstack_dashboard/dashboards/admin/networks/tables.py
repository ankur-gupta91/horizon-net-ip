...
class NetworksTable(tables.DataTable):
    ...
    external = tables.Column("router:external",
                             ...
                             filters=(filters.yesno, filters.capfirst))
    ip_availability = tables.Column("ip_availability",
                                    verbose_name=_("Total Used IPs"))
    free_ips = tables.Column(get_subnet_availability,
                             verbose_name=_("Subnet IP Availability"))
    ...
    def __init__(self, request, data=None, needs_form_wrapper=None, **kwargs):
        ...
        if not api.neutron.is_extension_supported(request,
            ...
            del self.columns['ip_availability']
            del self.columns['free_ips']
