...
def data(TEST):
    ...
    ip_availability_dict = {
        'used_ips': 4,
        'subnet_ip_availability': [{
            'used_ips': 2,
            'subnet_id': '6b79d257-1878-4c6d-9571-093cdb85dded',
            'remaining_ips': 251,
            ...
            'total_ips': 253}, {
            'used_ips': 2,
            'subnet_id': 'f0c17cb4-f786-4634-9ebe-8dca09434fe8',
            'remaining_ips': 18446744073709551612L,
            'subnet_name': 'ipv6-private-subnet',
            'ip_version': 6,
            'cidr': 'fd9d:6f1:bb36::/64',
            'total_ips': 18446744073709551614L}],
        'network_id': '0fc2ab61-9eb6-476b-9939-0b58102a7468',
        'tenant_id': 'cfec01acd63742e5999ba3b512528e19',
        'network_name': 'private',
        'total_ips': 18446744073709551867L
    }
    TEST.ip_availability.add(ip_availability_dict)
    TEST.api_ip_availability.add(ip_availability_dict)
